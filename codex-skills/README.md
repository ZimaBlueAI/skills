...
- `gzh-design` — 微信公众号文章排版 + 一键复制预览页 + 13 套主题模板
...
gzh-design.zip
└── .codex/skills/gzh-design/         # 公众号排版 + 一键复制预览 + 主题库
```
...
unzip -o gzh-design/gzh-design.zip -d ~/
```
...
unzip -o codex-skills/gzh-design/gzh-design.zip -d /path/to/your-project/
```
